    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-800 dark:text-neutral-200 transition-colors duration-200 flex flex-col justify-between font-sans">
      ...
      <header className="border-b border-neutral-200/60 dark:border-neutral-900 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md sticky top-0 z-30 transition-all" id="header">
        <div className="max-w-7xl mx-auto px-4 h-16 flex justify-between items-center">
          ...
          >
            <div className="h-9 w-9 bg-neutral-900 text-white dark:bg-white dark:text-neutral-900 rounded-xl flex items-center justify-center font-black shadow-sm group-hover:scale-105 transition-transform">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            {/* Toggler de Tema (Claro / Escuro) */}
            <button
              onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
              className="p-2 rounded-full text-neutral-500 hover:text-neutral-900 dark:text-neutral-450 dark:hover:text-neutral-100 hover:bg-neutral-100 dark:hover:bg-neutral-900 bg-neutral-100/50 dark:bg-neutral-900/40 border border-neutral-200/40 dark:border-neutral-850 transition-all cursor-pointer shadow-xs shrink-0"
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {theme === "dark" ? (
                    ...
                    <Moon className="h-4.5 w-4.5 text-indigo-600 fill-indigo-600/20" />
                  )}
                </motion.div>
              </AnimatePresence>
            </button>
            ...
            {user ? (
              <div className="flex items-center gap-3 bg-neutral-100/50 dark:bg-neutral-900/60 border border-neutral-200/50 dark:border-neutral-850 py-1.5 px-3 rounded-full">
                <div className="h-6 w-6 rounded-full bg-brand-blue text-white text-xs font-bold flex items-center justify-center uppercase shadow-inner">
                  {user.name.charAt(0)}
                </div>
                <div className="hidden sm:flex flex-col items-start leading-none">
                  <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 text-left">
                    {user.name}
                  </span>
                  <span className="text-[9px] text-neutral-400 font-mono">estudante</span>
                </div>
                <button
                  onClick={handleLogout}
                  className="p-1 hover:text-red-500 text-neutral-400 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors cursor-pointer ml-1"
                  title="Sair da Conta"
                >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold text-neutral-900 dark:text-neutral-50 hover:bg-neutral-100 dark:hover:bg-neutral-900 bg-neutral-100/40 dark:bg-neutral-900/40 border border-neutral-200 dark:border-neutral-850 px-4 py-2 rounded-full transition-colors cursor-pointer"
              >
