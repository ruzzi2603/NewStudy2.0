          ...
          <div className="bg-neutral-900 dark:bg-neutral-950 border border-neutral-800 rounded-xl p-5 text-white flex flex-col gap-4 relative overflow-hidden shadow-sm">
            ...
            <div className="flex flex-col gap-2 relative z-10">
              ...
              <button
                ...
                className="w-full py-2 bg-neutral-800 text-neutral-105 hover:bg-neutral-750 text-xs font-bold rounded-lg border border-neutral-700 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                id="recall-quiz-btn"
              >
                    ...
                    <div className="flex flex-col gap-6">
                      {lecture.formulas.map((formula, idx) => (
                        ...
                        >
                          ...
                          <div className="font-mono text-center text-base bg-neutral-900 text-neutral-105 dark:bg-neutral-950 p-4 rounded-lg font-semibold overflow-x-auto border border-neutral-850 shadow-inner">
                            {formula.latex}
                          </div>
